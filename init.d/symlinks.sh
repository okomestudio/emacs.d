...
ptom["40"]="subsys-completion subsys-editing subsys-flycheck subsys-git subsys-lookup polymode tesseract"
ptom["50"]="maj-text-mode"
ptom["52"]="markdown rst maj-yaml"
ptom["54"]="conf-mode"
ptom["60"]="maj-prog-mode formatter"
ptom["62"]="c css docker maj-elisp html javascript kotlin maj-python rust scala shell sql"
