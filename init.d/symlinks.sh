...
ptom["62"]="maj-c maj-css maj-docker maj-elisp maj-html maj-javascript maj-kotlin maj-python maj-rust maj-scala maj-sh maj-sql"
ptom["64"]="maj-ansible excalidraw maj-graphviz maj-json maj-plantuml restclient"
ptom["70"]="epub pdf"
