...
ptom["04"]="subsys-help subsys-buffer subsys-minibuffer subsys-navigation"
...
ptom["30"]="subsys-auth subsys-term subsys-consult subsys-embark subsys-lsp"
ptom["40"]="subsys-completion subsys-editing subsys-git subsys-lookup"
