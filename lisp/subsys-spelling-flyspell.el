;;; subsys-spelling-flyspell.el --- Spelling Subsystem  -*- lexical-binding: t -*-
;;; Commentary:
;;
...
(provide 'subsys-spelling-flyspell)
;;; subsys-spelling-flyspell.el ends here
